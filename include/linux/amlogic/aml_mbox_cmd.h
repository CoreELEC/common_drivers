...
#define CMD_SET_USB_POWER     0x100
#define CMD_SET_REMOTE        0x101
#define CMD_SET_IR_PROTOCOL   0x102
#define CMD_SET_REMOTE_MASK   0x103
#define CMD_SET_GPIO_POWER    0x104
...
#define MBOX_CMD_SET_USB_POWER		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_USB_POWER)
#define MBOX_CMD_SET_REMOTE		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_REMOTE)
#define MBOX_CMD_SET_IR_PROTOCOL		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_IR_PROTOCOL)
#define MBOX_CMD_SET_REMOTE_MASK		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_REMOTE_MASK)
#define MBOX_CMD_SET_GPIO_POWER		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SET_GPIO_POWER)
