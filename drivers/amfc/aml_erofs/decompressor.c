...
static int __nocfi z_erofs_lz4_decompress_mem(struct z_erofs_decompress_req *rq,
				      u8 *out)
{
	...
	if (rq->partial_decoding || !support_0padding)
		ret = f_LZ4_decompress_safe_partial(src + inputmargin, out,
				rq->inputsize, rq->outputsize, rq->outputsize);
	else
		ret = f_LZ4_decompress_safe(src + inputmargin, out,
