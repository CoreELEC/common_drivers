...
static snd_pcm_uframes_t extn_pointer(struct snd_soc_component *component,
...
static int extn_open(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct device *dev = asoc_rtd_to_cpu(rtd, 0)->dev;
...
static int extn_close(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
static int extn_hw_params(struct snd_soc_component *component,
			struct snd_pcm_substream *substream,
...
static int extn_hw_free(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	snd_pcm_lib_free_pages(substream);
...
static int extn_prepare(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct extn *p_extn = runtime->private_data;
...
static int extn_mmap(struct snd_soc_component *component,
		struct snd_pcm_substream *substream,
...
static int extn_ioctl(struct snd_soc_component *component,
	struct snd_pcm_substream *substream,
