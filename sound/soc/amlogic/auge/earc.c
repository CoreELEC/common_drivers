...
static int earc_open(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
...
static int earc_close(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
static int earc_hw_params(struct snd_soc_component *component,
			struct snd_pcm_substream *substream,
...
static int earc_hw_free(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	snd_pcm_lib_free_pages(substream);
...
static int earc_prepare(struct snd_soc_component *component, struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct earc *p_earc = runtime->private_data;
...
static snd_pcm_uframes_t earc_pointer(struct snd_soc_component *component,
	struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct earc *p_earc = runtime->private_data;
...
static int earc_mmap(struct snd_soc_component *component,
		struct snd_pcm_substream *substream,
...
static int earc_ioctl(struct snd_soc_component *component,
	struct snd_pcm_substream *substream,
