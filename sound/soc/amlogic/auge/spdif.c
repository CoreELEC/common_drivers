...
/*
 * S/PDIF ALSA SoC Digital Audio Interface (DAI) driver
 *
...
static int aml_spdif_close(struct snd_soc_component *component,
			   struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
...
static int aml_spdif_hw_params(struct snd_soc_component *component,
			       struct snd_pcm_substream *substream,
...
static int aml_spdif_hw_free(struct snd_soc_component *component,
			     struct snd_pcm_substream *substream)
{
	snd_pcm_lib_free_pages(substream);
...
static int aml_spdif_prepare(struct snd_soc_component *component,
			     struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct aml_spdif *p_spdif = runtime->private_data;
...
static snd_pcm_uframes_t aml_spdif_pointer(struct snd_soc_component *component,
					   struct snd_pcm_substream *substream)
{
	struct snd_pcm_runtime *runtime = substream->runtime;
	struct aml_spdif *p_spdif = runtime->private_data;
...
static int aml_spdif_mmap(struct snd_soc_component *component,
			  struct snd_pcm_substream *substream,
...
static int aml_spdif_ioctl(struct snd_soc_component *component,
			   struct snd_pcm_substream *substream,
...
static const struct snd_soc_dai_ops aml_dai_spdif_ops = {
...
#define AML_DAI_SPDIF_RATES	(SNDRV_PCM_RATE_32000 |\
